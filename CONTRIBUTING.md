# Contributing to App Promo Studio
...
If you find a bug, please [open an issue](https://github.com/ChanMeng666/app-promo-studio/issues/new) with:
...
Have an idea? [Open a feature request](https://github.com/ChanMeng666/app-promo-studio/issues/new) describing the problem you want to solve and your proposed solution.

### Submitting Changes

1. **Fork** the repository and **clone** your fork:
   ```bash
   git clone https://github.com/<your-username>/app-promo-studio.git
   cd app-promo-studio
   ```
